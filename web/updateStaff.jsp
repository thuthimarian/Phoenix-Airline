<%-- 
    ...
    Created on : Apr 27, 2021, 5:58:02 AM
    Author     : HP
--%>
...
<html>
    ...
    <body>
		...
		<a href="HomePage.html">Home</a>
                ...
                <a href="EditProfileStaff.jsp">Back to Edit Page</a>
                <a href="javascript:void(0);" class="icon" onclick="myFunction()">
                    <i class="fa fa-bars"></i>
                </a>
	</div>
        <center>
        <p class="topic">Staff Update</p>
         <form action="EditStaffServlet" method="POST">
            <table border="0" cellspacing="9">
                <tr>
                    ...
                    <tr>
                        <td><input class="input-field" type="submit" value="UPADATE" /></td>
