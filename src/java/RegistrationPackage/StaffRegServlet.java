...
public class StaffRegServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StaffRegServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StaffRegServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(name.equals("")||email.equals("")||tele.equals("")||ukey.equals("")||pass.equals("")||copass.equals("")||address.equals("")){
            ...
            if(copass.equals(pass)){
                ...
                ur.staffAddInfo(ukey,name,email,tele,pass,copass,address);
                response.sendRedirect("HomePage.html");
            }else{
                out.println("<script type=\"text/javascript\">");
                    out.println("alert('Passwords do not match');");
                    out.println("location='StaffRegistration.html'");
                    out.println("</script>");
            }
        }
    }
